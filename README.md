...
# Patron
PATRON_SONUC_KANAL_ID=123456789  # Patron savaş sonuç sıralaması kanalı

# Yedekleme (Railway production için zorunlu)
YEDEK_KANAL_ID=123456789   # Private yedek kanalının ID'si
